        ...
        try {
            ...
            if (type !== "edit") {
                ...
                response = await EditIssue({
                    book: selectedBook._id,
                    user: selectedIssue.user._id,//patronData._id,
                    issueDate: selectedIssue.issueDate,
                    returnDate,
                    rent: moment(returnDate).diff(moment(selectedIssue.issueDate), "days") * selectedBook?.rentPerDay,
                    fine: selectedIssue.fine,
                    issueBy: user._id,
        ...
        >
            <div className='flex flex-col gap-2 '>
                ...
                <div className='flex justify-end gap-2 w-100 '>
                    ...
                    {validated &&
                        <Button title={type === "edit" ? "Edit" : "Issue"} onClick={onIssue}
                            disabled={patronId === "" || returnDate === ""}
                        />
                    }
                </div>
